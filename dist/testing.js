...
var ApolloLink = (function () {
    ...
    ApolloLink.prototype.request = function (operation, forward) {
        throw process.env.NODE_ENV === "production" ? new invariant.InvariantError(20) : new invariant.InvariantError('request is not implemented');
    };
...
var Reobserver = (function () {
    ...
    Reobserver.prototype.updatePolling = function () {
        ...
        process.env.NODE_ENV === "production" ? invariant.invariant(pollInterval, 21) : invariant.invariant(pollInterval, 'Attempted to start a polling query without a polling interval.');
